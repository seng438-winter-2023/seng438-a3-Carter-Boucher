...
public class DataUtilitiesTest3 extends DataUtilities {	
	/*
	...
	public void calculateColumnWithNull() throws Exception {
		...
		int columnIndex = 0;
		Values2D data = null;
		double answer =  DataUtilities.calculateColumnTotal(data, columnIndex);	
	}
	...
	public void calculateRowWithNull() throws Exception {
		...
		int rowIndex = 0;
		Values2D data = null;
		double answer =  DataUtilities.calculateRowTotal(data, rowIndex);
	}
	...
	//create an array of one negative element and pass into function
	//should return same one element array
	@Test
	public void createNumberArrayOneElementPos() {
		//expected output
	...
	//create an array of one positive element and pass into function
	//should return same one element array
	@Test
	public void createNumberArrayOneElementNeg() {
		//expected output
		Number[] expectedArray = {-0.5};
		//test array input into function
		double[] testArray = {-0.5};
	...
	//create an array of two positive elements and pass into function
	//should return same two element array
	@Test
	public void createNumberArrayTwoElementsPos() {
		//expected output
	...
	//create an array of two negative elements and pass into function
	//should return same two element array
	@Test
	public void createNumberArrayTwoElementsNeg() {
		//expected output
		Number[] expectedArray = {-0.5,-1.5};
		//test array input into function
		double[] testArray = {-0.5,-1.5};
	...
	//create a double array of one postive element and pass to function
	//should return same array
	@Test
	public void create2DNumberArrayOneElementPos() {
		//expected output
	...
	//create a double array of one negative element and pass to function
	//should return same array
	@Test
	public void create2DNumberArrayOneElementNeg() {
		//expected output
		Number[][] expectedArray = {{-0.5},{-0.5}};
		//test array to pass to function
		double[][] testArray = {{-0.5},{-0.5}};
	...
	//create a double array of two positive elements and pass to function
	//should return same array
	@Test
	public void create2DNumberArrayTwoElementPos() {
		//expected output
	...
	//create a double array of two negative elements and pass to function
	//should return same array
	@Test
	public void create2DNumberArrayTwoElementNeg() {
		//expected output
		Number[][] expectedArray = {{-0.5,-1.5},{-0.5,-1.5}};
		//test array to pass to function
		double[][] testArray = {{-0.5,-1.5},{-0.5,-1.5}};
...
//        //index value for key 2
    ...
    @Test
    public void getCumulativePercentagesTotalNullFirst(){
    	try {
    		double total = valuesNull.getValue(0).doubleValue();
    	}
    	catch(Exception e) {
    ...
    //should return the total for all valuesNull
    @Test
    public void getCumulativePercentagesTotalNullSecond(){
    	try {
    		double total = valuesNull.getValue(1).doubleValue();
    	}
    	catch(Exception e) {
    		assertEquals("Should throw NullPointerException", NullPointerException.class,
					e.getClass());
    ...
    //should return the total for all valuesNull
    @Test
    public void getCumulativePercentagesTotalNullThird(){
    	try {
    		valuesNull.getValue(2).doubleValue();
    	}
    	catch(Exception e) {
    		assertEquals("Should throw NullPointerException", NullPointerException.class,
					e.getClass());
    ...
    //test the data value for each index
    @Test
    public void getCumulativePercentagesvaluesWithKeyNullFirst(){
    	try {
    		//value at index zero should be five
    		double value = valuesNull.getValue(0).doubleValue();
    	}
    	catch(Exception e){
    		assertEquals("Should throw NullPointerException", NullPointerException.class,
					e.getClass());
    ...
    //test the data value for each index
    @Test
    public void getCumulativePercentagesvaluesWithKeyNullSecond(){
    	try {
    		//value at index zero should be five
    		double value = valuesNull.getValue(1).doubleValue();
    	}
    	catch(Exception e){
    		assertEquals("Should throw NullPointerException", NullPointerException.class,
					e.getClass());
    ...
    //test the data value for each index
    @Test
    public void getCumulativePercentagesvaluesWithKeyNullThird(){
    	try {
    		//value at index zero should be five
    		double value = valuesNull.getValue(2).doubleValue();
    	}
    	catch(Exception e){
    		assertEquals("Should throw NullPointerException", NullPointerException.class,
					e.getClass());
